...
public class UnderlinePageIndicator extends View implements PageIndicator
{
    ...
    public UnderlinePageIndicator(final Context context, final AttributeSet set, final int n) {
        ...
        this.setFades(obtainStyledAttributes.getBoolean(R.styleable.UnderlinePageIndicator_fades, boolean1));
        this.setSelectedColor(obtainStyledAttributes.getColor(R.styleable.UnderlinePageIndicator_selectedColor, color));
        this.setFadeDelay(obtainStyledAttributes.getInteger(R.styleable.UnderlinePageIndicator_fadeDelay, integer));
        this.setFadeLength(obtainStyledAttributes.getInteger(R.styleable.UnderlinePageIndicator_fadeLength, integer2));
        final Drawable drawable = obtainStyledAttributes.getDrawable(R.styleable.UnderlinePageIndicator_android_background);
        if (drawable != null) {
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        if (this.mViewPager != null) {
            ...
            if (count != 0) {
                ...
                final float n2 = paddingLeft + n * (this.mCurrentPage + this.mPositionOffset);
