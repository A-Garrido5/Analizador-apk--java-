...
public class Toolbar extends ViewGroup
{
    ...
    private static Context themifyContext(Context context, final AttributeSet set, final int n) {
        final TypedArray obtainStyledAttributes = context.obtainStyledAttributes(set, R.styleable.Toolbar, n, 0);
        final int resourceId = obtainStyledAttributes.getResourceId(R.styleable.Toolbar_theme, 0);
        if (resourceId != 0) {
    ...
    protected void onLayout(final boolean b, final int n, final int n2, final int n3, final int n4) {
        ...
        if (this.shouldLayout((View)this.mNavButtonView)) {
            if (b2) {
                n6 = this.layoutChildRight((View)this.mNavButtonView, n6, mTempMargins, minimumHeightCompat);
            }
            else {
                n5 = this.layoutChildLeft((View)this.mNavButtonView, n5, mTempMargins, minimumHeightCompat);
            }
        }
        if (this.shouldLayout((View)this.mCollapseButtonView)) {
            if (b2) {
                n6 = this.layoutChildRight((View)this.mCollapseButtonView, n6, mTempMargins, minimumHeightCompat);
            }
            else {
                n5 = this.layoutChildLeft((View)this.mCollapseButtonView, n5, mTempMargins, minimumHeightCompat);
            }
        }
        if (this.shouldLayout((View)this.mMenuView)) {
            if (b2) {
                n5 = this.layoutChildLeft((View)this.mMenuView, n5, mTempMargins, minimumHeightCompat);
            }
            else {
                n6 = this.layoutChildRight((View)this.mMenuView, n6, mTempMargins, minimumHeightCompat);
            }
        }
        ...
        if (this.shouldLayout((View)this.mLogoView)) {
            if (b2) {
                ...
                n7 = this.layoutChildLeft((View)this.mLogoView, n7, mTempMargins, minimumHeightCompat);
            }
        }
        ...
        for (int size = this.mTempViews.size(), i = 0; i < size; ++i) {
            n7 = this.layoutChildLeft(this.mTempViews.get(i), n7, mTempMargins, minimumHeightCompat);
        }
        this.addCustomViewsWithGravity(this.mTempViews, 5);
        for (int size2 = this.mTempViews.size(), j = 0; j < size2; ++j) {
            n8 = this.layoutChildRight(this.mTempViews.get(j), n8, mTempMargins, minimumHeightCompat);
        }
        ...
        for (int size3 = this.mTempViews.size(), k = 0; k < size3; ++k) {
            layoutChildLeft = this.layoutChildLeft(this.mTempViews.get(k), layoutChildLeft, mTempMargins, minimumHeightCompat);
        }
