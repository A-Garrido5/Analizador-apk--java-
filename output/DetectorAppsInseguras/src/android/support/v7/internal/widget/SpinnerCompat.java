...
class SpinnerCompat extends AbsSpinnerCompat implements DialogInterface$OnClickListener
{
    ...
    SpinnerCompat(final Context context, final AttributeSet set, final int n, int int1) {
        super(context, set, n);
    ...
    void layout(final int n, final boolean b) {
        ...
        if (this.mAdapter != null) {
            ...
            int n3 = left;
            switch (0x7 & GravityCompat.getAbsoluteGravity(this.mGravity, ViewCompat.getLayoutDirection((View)this))) {
                case 1: {
    ...
    private class DropdownPopup extends ListPopupWindow implements SpinnerPopup
    {
        ...
        void computeContentWidth() {
            ...
            if (SpinnerCompat.this.mDropDownWidth == -2) {
                int measureContentWidth = SpinnerCompat.this.measureContentWidth((SpinnerAdapter)this.mAdapter, this.getBackground());
