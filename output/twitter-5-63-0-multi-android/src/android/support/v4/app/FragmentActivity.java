...
public class FragmentActivity extends Activity
{
            ...
            while (true) {
                while (true) {
                    ...
                    while (true) {
                        Label_0253: {
                            while (true) {
                                Label_0236:Label_0533_Outer:Label_0539_Outer:Label_0552_Outer:Label_0564_Outer:
                                while (true) {
                                    Label_0215: {
                                    Label_0558_Outer:
                                        while (true) {
    ...
    public View onCreateView(final String s, @NonNull final Context context, @NonNull final AttributeSet set) {
        ...
        if (!"fragment".equals(s)) {
            ...
            view = this.mFragments.onCreateView(s, context, set);
            if (view == null) {
    ...
    public final Object onRetainNonConfigurationInstance() {
        ...
        final ArrayList retainNonConfig = this.mFragments.retainNonConfig();
        boolean b;
        if (this.mAllLoaderManagers != null) {
            final int size = this.mAllLoaderManagers.size();
            final LoaderManagerImpl[] array = new LoaderManagerImpl[size];
            for (int j = size - 1; j >= 0; --j) {
                array[j] = (LoaderManagerImpl)this.mAllLoaderManagers.valueAt(j);
            }
            b = false;
            while (i < size) {
