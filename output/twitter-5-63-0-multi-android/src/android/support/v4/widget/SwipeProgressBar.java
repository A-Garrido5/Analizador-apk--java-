    ...
    void draw(final Canvas canvas) {
        ...
        if (this.mRunning || this.mFinishTime > 0L) {
            ...
            if (!this.mRunning) {
                ...
                final float n6 = width / 2 * SwipeProgressBar.INTERPOLATOR.getInterpolation((currentAnimationTimeMillis - this.mFinishTime) % 1000L / 10.0f / 100.0f);
            ...
            if (n5 >= 0.0f && n5 <= 25.0f) {
                this.drawCircle(canvas, n, n2, this.mColor1, 2.0f * (25.0f + n5) / 100.0f);
            }
            if (n5 >= 0.0f && n5 <= 50.0f) {
                this.drawCircle(canvas, n, n2, this.mColor2, 2.0f * n5 / 100.0f);
            }
            if (n5 >= 25.0f && n5 <= 75.0f) {
                this.drawCircle(canvas, n, n2, this.mColor3, 2.0f * (n5 - 25.0f) / 100.0f);
            }
            if (n5 >= 50.0f && n5 <= 100.0f) {
                this.drawCircle(canvas, n, n2, this.mColor4, 2.0f * (n5 - 50.0f) / 100.0f);
            }
            if (n5 >= 75.0f && n5 <= 100.0f) {
                this.drawCircle(canvas, n, n2, this.mColor1, 2.0f * (n5 - 75.0f) / 100.0f);
            }
            int save2;
