    ...
    public boolean onTouchEvent(final MotionEvent motionEvent) {
        ...
        switch (action & 0xFF) {
            ...
            case 0: {
                while (true) {
                    Label_0634: {
                        ...
                        final boolean b2 = false | this.mDoubleTapListener.onDoubleTap(this.mCurrentDownEvent) | this.mDoubleTapListener.onDoubleTapEvent(motionEvent);
                        this.mLastFocusX = n4;
                        this.mDownFocusX = n4;
                        this.mLastFocusY = n5;
                        this.mDownFocusY = n5;
            ...
            case 1: {
                ...
                if (this.mIsDoubleTapping) {
                    onSingleTapUp = (false | this.mDoubleTapListener.onDoubleTapEvent(motionEvent));
                }
                    ...
                    onSingleTapUp = this.mListener.onSingleTapUp(motionEvent);
