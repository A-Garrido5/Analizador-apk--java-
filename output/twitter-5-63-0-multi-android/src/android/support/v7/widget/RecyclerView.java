...
public class RecyclerView extends ViewGroup
{
    ...
    private void animateDisappearance(final RecyclerView$ItemHolderInfo recyclerView$ItemHolderInfo) {
        ...
        if (left != left2 || top != top2) {
            ...
            itemView.layout(left2, top2, left2 + itemView.getWidth(), top2 + itemView.getHeight());
    ...
    private void processAdapterUpdatesAndSetAnimationFlags() {
        ...
        final boolean b2 = ((this.mItemsAddedOrRemoved && !this.mItemsChanged) || this.mItemsAddedOrRemoved || (this.mItemsChanged && this.supportsChangeAnimations())) && b;
    ...
    private void processDisappearingList(final ArrayMap arrayMap) {
        for (int size = this.mDisappearingViewsInLayoutPass.size(), i = 0; i < size; ++i) {
            ...
            final RecyclerView$ItemHolderInfo recyclerView$ItemHolderInfo = (RecyclerView$ItemHolderInfo)this.mState.mPreLayoutHolderMap.remove(childViewHolderInt);
    ...
    void dispatchLayout() {
                    ...
                    while (true) {
                        while (l < this.mState.mPreLayoutHolderMap.size()) {
                            if (((RecyclerView$ViewHolder)this.mState.mPreLayoutHolderMap.keyAt(l)).itemView == child) {
                                final int n = 1;
                                if (n == 0) {
                                    arrayMap.put(child, new Rect(child.getLeft(), child.getTop(), child.getRight(), child.getBottom()));
                                }
                                continue Label_0487;
                            }
                            else {
        ...
        if (this.mState.mRunSimpleAnimations) {
            ...
            this.processDisappearingList(arrayMap2);
            for (int n4 = -1 + this.mState.mPreLayoutHolderMap.size(); n4 >= 0; --n4) {
                if (!this.mState.mPostLayoutHolderMap.containsKey(this.mState.mPreLayoutHolderMap.keyAt(n4))) {
                    final RecyclerView$ItemHolderInfo recyclerView$ItemHolderInfo = (RecyclerView$ItemHolderInfo)this.mState.mPreLayoutHolderMap.valueAt(n4);
            ...
            if (size > 0) {
                for (int n5 = size - 1; n5 >= 0; --n5) {
                    final RecyclerView$ViewHolder recyclerView$ViewHolder = (RecyclerView$ViewHolder)this.mState.mPostLayoutHolderMap.keyAt(n5);
                    final RecyclerView$ItemHolderInfo recyclerView$ItemHolderInfo2 = (RecyclerView$ItemHolderInfo)this.mState.mPostLayoutHolderMap.valueAt(n5);
                    if (this.mState.mPreLayoutHolderMap.isEmpty() || !this.mState.mPreLayoutHolderMap.containsKey(recyclerView$ViewHolder)) {
                        ...
                        Rect rect;
                        if (arrayMap2 != null) {
                            rect = (Rect)arrayMap2.get(recyclerView$ViewHolder.itemView);
                        }
                        else {
                            rect = null;
                        }
            ...
            for (int size2 = this.mState.mPostLayoutHolderMap.size(), n6 = 0; n6 < size2; ++n6) {
                final RecyclerView$ViewHolder recyclerView$ViewHolder2 = (RecyclerView$ViewHolder)this.mState.mPostLayoutHolderMap.keyAt(n6);
                final RecyclerView$ItemHolderInfo recyclerView$ItemHolderInfo3 = (RecyclerView$ItemHolderInfo)this.mState.mPostLayoutHolderMap.valueAt(n6);
                final RecyclerView$ItemHolderInfo recyclerView$ItemHolderInfo4 = (RecyclerView$ItemHolderInfo)this.mState.mPreLayoutHolderMap.get(recyclerView$ViewHolder2);
            ...
            for (int n7 = size3 - 1; n7 >= 0; --n7) {
                final long longValue = (long)this.mState.mOldChangedHolders.keyAt(n7);
                final RecyclerView$ViewHolder recyclerView$ViewHolder3 = (RecyclerView$ViewHolder)this.mState.mOldChangedHolders.get(longValue);
                ...
                if (!recyclerView$ViewHolder3.shouldIgnore() && this.mRecycler.mChangedScrap != null && this.mRecycler.mChangedScrap.contains(recyclerView$ViewHolder3)) {
                    this.animateChange(recyclerView$ViewHolder3, (RecyclerView$ViewHolder)simpleArrayMap.get(longValue));
                }
            }
        }
        this.resumeRequestLayout(false);
    ...
    public void draw(final Canvas canvas) {
        ...
        for (int size = this.mItemDecorations.size(), i = 0; i < size; ++i) {
            ((RecyclerView$ItemDecoration)this.mItemDecorations.get(i)).onDrawOver(canvas, this, this.mState);
        }
        int n2;
        ...
        if (this.mBottomGlow != null && !this.mBottomGlow.isFinished()) {
            ...
            final EdgeEffectCompat mBottomGlow = this.mBottomGlow;
            int n5 = 0;
            if (mBottomGlow != null) {
                final boolean draw = this.mBottomGlow.draw(canvas);
                n5 = 0;
                if (draw) {
                    n5 = n;
                }
    ...
    public boolean fling(int n, int n2) {
        ...
        final int max = Math.max(-this.mMaxFlingVelocity, Math.min(n, this.mMaxFlingVelocity));
        final int max2 = Math.max(-this.mMaxFlingVelocity, Math.min(n2, this.mMaxFlingVelocity));
        if (max == 0) {
    ...
    public View focusSearch(final View view, final int n) {
        ...
        if (view2 == null) {
            ...
            if (view2 == null && this.mAdapter != null) {
                this.eatRequestLayout();
    ...
    Rect getItemDecorInsetsForChild(final View view) {
        ...
        for (int size = this.mItemDecorations.size(), i = 0; i < size; ++i) {
            ...
            ((RecyclerView$ItemDecoration)this.mItemDecorations.get(i)).getItemOffsets(this.mTempRect, view, this, this.mState);
    ...
    public void onDraw(final Canvas canvas) {
        super.onDraw(canvas);
        for (int size = this.mItemDecorations.size(), i = 0; i < size; ++i) {
            ((RecyclerView$ItemDecoration)this.mItemDecorations.get(i)).onDraw(canvas, this, this.mState);
        }
    }
            ...
            switch (actionMasked) {
                ...
                case 2: {
                    ...
                    if (canScrollHorizontally && Math.abs(n8) > this.mTouchSlop) {
                        ...
                        this.mLastTouchX = mInitialTouchX + n10 * mTouchSlop;
                        n11 = 1;
                    }
                    else {
                        n11 = 0;
                    ...
                    if (canScrollVertically && Math.abs(n9) > this.mTouchSlop) {
                        ...
                        this.mLastTouchY = mInitialTouchY + n * mTouchSlop2;
                        n11 = 1;
                    }
                    if (n11 != 0) {
                        this.getParent().requestDisallowInterceptTouchEvent(true);
    ...
    public boolean onTouchEvent(final MotionEvent motionEvent) {
        ...
        switch (actionMasked) {
            ...
            case 2: {
                ...
                final int mLastTouchX = (int)(0.5f + MotionEventCompat.getX(motionEvent, pointerIndex));
                final int mLastTouchY = (int)(0.5f + MotionEventCompat.getY(motionEvent, pointerIndex));
                if (this.mScrollState != 1) {
                    ...
                    if (canScrollHorizontally && Math.abs(n6) > this.mTouchSlop) {
                        ...
                        this.mLastTouchX = mInitialTouchX + n8 * mTouchSlop;
                        n9 = 1;
                    }
                    else {
                        n9 = 0;
                    }
                    if (canScrollVertically && Math.abs(n7) > this.mTouchSlop) {
                        final int mInitialTouchY = this.mInitialTouchY;
                        final int mTouchSlop2 = this.mTouchSlop;
                        if (n7 >= 0) {
                            n = 1;
                ...
                if (this.mScrollState == 1) {
                    final int n10 = mLastTouchX - this.mLastTouchX;
                    final int n11 = mLastTouchY - this.mLastTouchY;
                    int n12;
            ...
            case 1: {
                ...
                float n14;
                if (canScrollHorizontally) {
                    n14 = -VelocityTrackerCompat.getXVelocity(this.mVelocityTracker, this.mScrollPointerId);
                }
                else {
                    n14 = 0.0f;
                }
                float n15;
                if (canScrollVertically) {
                    n15 = -VelocityTrackerCompat.getYVelocity(this.mVelocityTracker, this.mScrollPointerId);
                }
                else {
                    n15 = 0.0f;
                }
    ...
    void scrollByInternal(final int n, final int n2) {
        ...
        if (this.mAdapter != null) {
            ...
            final int n5 = scrollHorizontallyBy;
            n6 = n4;
            n7 = n5;
        }
        else {
        ...
        if (ViewCompat.getOverScrollMode((View)this) != 2) {
            ...
            this.pullGlows(n3, n6);
        }
        if (n7 != 0 || scrollVerticallyBy != 0) {
            this.onScrollChanged(0, 0, 0, 0);
            if (this.mScrollListener != null) {
                this.mScrollListener.onScrolled(this, n7, scrollVerticallyBy);
            }
        }
