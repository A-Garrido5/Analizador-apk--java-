...
class StaggeredGridLayoutManager$LazySpanLookup
{
    ...
    private void offsetFullSpansForRemoval(final int n, final int n2) {
        if (this.mFullSpanItems != null) {
            ...
            for (int i = -1 + this.mFullSpanItems.size(); i >= 0; --i) {
                final StaggeredGridLayoutManager$LazySpanLookup$FullSpanItem staggeredGridLayoutManager$LazySpanLookup$FullSpanItem = this.mFullSpanItems.get(i);
                if (staggeredGridLayoutManager$LazySpanLookup$FullSpanItem.mPosition >= n) {
                    if (staggeredGridLayoutManager$LazySpanLookup$FullSpanItem.mPosition < n3) {
                        this.mFullSpanItems.remove(i);
                    }
                    else {
                        staggeredGridLayoutManager$LazySpanLookup$FullSpanItem.mPosition -= n2;
    ...
    public StaggeredGridLayoutManager$LazySpanLookup$FullSpanItem getFirstFullSpanItemInRange(final int n, final int n2, final int n3) {
        if (this.mFullSpanItems != null) {
            for (int i = 0; i < this.mFullSpanItems.size(); ++i) {
                ...
                if (staggeredGridLayoutManager$LazySpanLookup$FullSpanItem.mPosition >= n && (n3 == 0 || staggeredGridLayoutManager$LazySpanLookup$FullSpanItem.mGapDir == n3)) {
