...
final class b implements Callable
{
    ...
    private Boolean a() {
        try {
            final boolean delete = this.a.l.delete();
            cl.a().b().a("Crashlytics", "Initialization marker file removed: " + delete);
            return delete;
        }
        catch (Exception ex) {
            cl.a().b().a("Crashlytics", "Problem encountered deleting Crashlytics initialization marker.", ex);
            return false;
        }
    }
}
