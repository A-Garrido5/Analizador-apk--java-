...
public class PurchaseRequestParameter implements Externalizable
{
    ...
    public boolean equals(final Object o) {
        if (this != o) {
            if (!(o instanceof PurchaseRequestParameter)) {
                return false;
            }
            final PurchaseRequestParameter purchaseRequestParameter = (PurchaseRequestParameter)o;
            if (this.id != purchaseRequestParameter.id) {
                return false;
            }
            Label_0064: {
                if (this.key != null) {
                    if (this.key.equals(purchaseRequestParameter.key)) {
                        break Label_0064;
                    }
                }
                else if (purchaseRequestParameter.key == null) {
                    break Label_0064;
                }
                return false;
            }
