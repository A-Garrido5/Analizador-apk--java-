...
class bg implements Runnable
{
    ...
    public void run() {
        ...
        this.a.cP.onTouch((View)this.a.cP, MotionEvent.obtain(SystemClock.uptimeMillis(), SystemClock.uptimeMillis(), 0, 1.0f, 1.0f, 0));
        this.a.invalidate();
        new Handler().postDelayed((Runnable)new bh(this), 100L);
    }
}
