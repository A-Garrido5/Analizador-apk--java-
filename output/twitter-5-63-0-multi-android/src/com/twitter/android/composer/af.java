...
class af implements ViewTreeObserver$OnGlobalLayoutListener
{
    ...
    af(final ComposerActivity d, final View a, final Rect b, final int c) {
        this.d = d;
        this.a = a;
        this.b = b;
        this.c = c;
    ...
    public void onGlobalLayout() {
        if (this.d.K.getVisibility() == 8) {
            ...
            this.d.K.getViewTreeObserver().removeGlobalOnLayoutListener((ViewTreeObserver$OnGlobalLayoutListener)this);
            return;
        }
        this.d.K.getHitRect(this.b);
        this.b.inset(-this.c, -this.c);
        this.a.setTouchDelegate(new TouchDelegate(this.b, (View)this.d.K));
    }
}
