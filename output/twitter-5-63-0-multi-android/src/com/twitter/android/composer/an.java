...
class an implements AttachMediaListener
{
    final /* synthetic */ ComposerActivity a;
    private final boolean b;
    
    an(final ComposerActivity a, final boolean b) {
        this.a = a;
        this.b = b;
    }
    ...
    public void a(final AttachMediaListener$MediaAttachFailure attachMediaListener$MediaAttachFailure, final Uri uri) {
        ...
        this.a.af();
        Toast.makeText((Context)this.a, (CharSequence)this.a.getString(2131297165), 1).show();
    }
    
    @Override
    public boolean a(final EditableMedia editableMedia) {
        return this.a.b(editableMedia, true);
    }
