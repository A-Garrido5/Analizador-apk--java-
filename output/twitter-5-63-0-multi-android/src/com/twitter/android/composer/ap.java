...
class ap implements Runnable
{
    ...
    public void run() {
        if (this.b.a) {
            if (this.a > 0L) {
                b(this.a, this.b.c, this.b.d, this.b.e);
            }
        }
        else {
            final ComposerActivity composerActivity = (ComposerActivity)this.b.b.get();
            if (composerActivity != null) {
                composerActivity.ae = this.a;
                composerActivity.ad = 2;
                composerActivity.af = null;
            }
        }
    }
}
