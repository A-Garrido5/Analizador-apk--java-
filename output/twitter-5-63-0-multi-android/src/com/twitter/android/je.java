...
final class je extends uh
{
    final /* synthetic */ HomeTimelineFragment a;
    
    public je(final HomeTimelineFragment a, final Fragment fragment, final TwitterScribeAssociation twitterScribeAssociation, final String s, final ul ul) {
        this.a = a;
        super(fragment, twitterScribeAssociation, s, ul, -1L);
    }
    
    @Override
    public void a(final Tweet tweet, final UrlEntity urlEntity) {
        if (!TextUtils.isEmpty((CharSequence)tweet.u)) {
            super.a(tweet, urlEntity, this.a.m() + "::" + tweet.u + ":link:open_link");
            return;
        }
