...
class vy implements DialogInterface$OnClickListener
{
    final /* synthetic */ TweetFragment a;
    
    vy(final TweetFragment a) {
        this.a = a;
    }
    
    public void onClick(final DialogInterface dialogInterface, final int n) {
        this.a.a(new f((Context)this.a.getActivity(), this.a.a, this.a.b.D, this.a.b.E).a(this.a.b.j), 3, 0);
        this.a.n(true);
        this.a.f("favorite");
    }
}
