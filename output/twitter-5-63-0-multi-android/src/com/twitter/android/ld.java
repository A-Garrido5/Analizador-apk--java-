...
class ld implements Runnable
{
    ...
    public void run() {
        this.a.m();
        final String a = ScribeLog.a("home", null, null, "highlights", "auto_opt_in");
        final Session b = this.a.T().b();
        e.a(b.g(), new k((Context)this.a, b.e()), (Context)this.a, this.a.G(), a);
        this.a.Q();
    }
}
