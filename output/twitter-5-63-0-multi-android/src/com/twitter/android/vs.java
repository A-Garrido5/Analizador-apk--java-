...
class vs implements View$OnClickListener
{
    ...
    vs(final TweetActivity a) {
        this.a = a;
    }
    
    public void onClick(final View view) {
        this.a.G().a(this.a.U().g(), "tweet:notification_landing:vit_tweet_embedded::click");
        this.a.startActivity(new Intent((Context)this.a, (Class)TweetActivity.class).putExtra("tw", (Parcelable)this.a.R));
    }
}
