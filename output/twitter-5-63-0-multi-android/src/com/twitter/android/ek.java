...
class ek
{
    ...
    public ek(final dz k, final View view, final boolean l) {
        this.k = k;
        ...
        this.c = (TextView)view.findViewById(2131886647);
        this.g = (LinearLayout)view.findViewById(2131886648);
        this.h = (Button)view.findViewById(2131886649);
        this.i = (Button)view.findViewById(2131886650);
        ...
        this.j = (TextView)view.findViewById(2131886645);
        this.l = l;
    }
    ...
    public void a(final x x) {
        if (x.c()) {
            ...
            if (this.l) {
                this.a.setOnClickListener((View$OnClickListener)new el(this, x));
            }
        ...
        if (!TextUtils.isEmpty((CharSequence)f)) {
            this.a.setContentDescription((CharSequence)this.k.i.getString(2131297097, new Object[] { f }));
        }
    }
}
