...
class wi implements r
{
    final /* synthetic */ TweetView a;
    final /* synthetic */ TweetFragment b;
    
    wi(final TweetFragment b, final TweetView a) {
        this.b = b;
        this.a = a;
    }
    
    @Override
    public void a(final TweetMediaView tweetMediaView, final MediaEntity mediaEntity, final boolean b) {
        if (b) {
    ...
    @Override
    public void a(final TweetMediaView tweetMediaView, final TweetClassicCard tweetClassicCard, final boolean b) {
        if (b) {
            this.b.a("show", this.a.getTweet());
        }
    }
    ...
    @Override
    public void a(final TweetMediaView tweetMediaView, final EditableMedia editableMedia, final boolean b) {
        if (b) {
            this.b.a("show", this.a.getTweet());
        }
    }
