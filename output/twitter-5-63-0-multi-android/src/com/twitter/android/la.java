...
class la implements SharedPreferences$OnSharedPreferenceChangeListener
{
    final /* synthetic */ MainActivity a;
    
    la(final MainActivity a) {
        this.a = a;
    }
    
    public void onSharedPreferenceChanged(final SharedPreferences sharedPreferences, final String s) {
        if ("connect_tab".equals(s) || "vit_filters".equals(s) || "notifications_follow_only".equals(s)) {
            final boolean boolean1 = sharedPreferences.getBoolean("connect_tab", false);
            if (this.a.B != boolean1) {
                this.a.B = boolean1;
            }
        }
    }
