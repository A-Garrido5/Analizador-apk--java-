...
class lp extends ay
{
    ...
    public lp(final MainActivity a) {
        this.a = a;
    }
    ...
    public void a(final Session session) {
        ...
        this.a.b(session.e());
        this.a.p();
        final Iterator<gm> iterator = (Iterator<gm>)this.a.l.a().iterator();
        while (iterator.hasNext()) {
            final TwitterListFragment twitterListFragment = (TwitterListFragment)iterator.next().a(this.a.getSupportFragmentManager());
    ...
    public void a(final Session session, final boolean b) {
        this.a.g.removeCallbacksAndMessages((Object)session);
    }
    
    @Override
    public void b(final Session session) {
        if (session.equals(this.a.U())) {
            this.a.n();
            this.a.u();
            this.a.t();
        }
