...
class lg implements LoaderManager$LoaderCallbacks
{
    final /* synthetic */ MainActivity a;
    
    public lg(final MainActivity a) {
        this.a = a;
    }
    ...
    public Loader onCreateLoader(final int n, final Bundle bundle) {
        return new CursorLoader((Context)this.a, Uri.withAppendedPath(p.a, this.a.U().e()), l.a, null, null, null);
    }
