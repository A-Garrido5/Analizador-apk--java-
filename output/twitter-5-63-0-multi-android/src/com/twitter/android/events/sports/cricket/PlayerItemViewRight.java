...
public class PlayerItemViewRight extends RelativeLayout
{
    ...
    public PlayerItemViewRight(final Context context) {
        this(context, null, 0);
    }
    
    public PlayerItemViewRight(final Context context, final AttributeSet set) {
        this(context, set, 0);
    }
    
    public PlayerItemViewRight(final Context d, final AttributeSet set, final int n) {
        super(d, set);
        this.d = d;
        this.e = LayoutInflater.from(this.d).inflate(2130968705, (ViewGroup)this, true);
