...
class ks extends AsyncTask
{
    ...
    public ks(final LoginVerificationFragment a, final Context context, final String c, final String d, final String e) {
        this.a = a;
    ...
    public void a(final q q) {
        if (q == null) {
            this.a.e();
            this.a.aw().a(this.a.a.g(), "login_verification::request:accept:error");
            this.a.f(this.c);
            return;
        }
        this.a.a(new a((Context)this.a.getActivity(), this.a.a, q), 3, 0);
    }
    
    protected void onPreExecute() {
        this.a.a(this.a.getString(2131297207));
    }
}
