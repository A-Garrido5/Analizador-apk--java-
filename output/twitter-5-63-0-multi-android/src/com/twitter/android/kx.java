...
class kx implements View$OnClickListener
{
    ...
    kx(final kw b, final LoginVerificationRequest a) {
        this.b = b;
        this.a = a;
    }
    
    public void onClick(final View view) {
        final TwitterScribeLog twitterScribeLog = (TwitterScribeLog)new TwitterScribeLog(this.b.a.a.g()).b(new String[] { "login_verification::request:accept:click" });
        twitterScribeLog.a(TwitterScribeItem.b(this.a.b));
        this.b.a.aw().a(twitterScribeLog);
        new ks(this.b.a, this.b.a.getActivity().getApplicationContext(), this.a.g, this.a.b, this.a.c).execute((Object[])new Void[0]);
    }
}
