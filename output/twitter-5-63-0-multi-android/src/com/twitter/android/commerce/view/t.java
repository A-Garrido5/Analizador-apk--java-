...
final class t extends z
{
    ...
    public t(final OfferSummaryActivity offerSummaryActivity) {
        this.a = new WeakReference((T)offerSummaryActivity);
    }
    ...
    public void a(final y y) {
        if (!this.b) {
            ...
            Bundle bundle;
            if (aa.a()) {
                bundle = aa.c.getBundle("offer_details_bundle");
            }
            else {
                bundle = aa.c.getBundle("commerce_error_list_bundle");
            }
            final OfferSummaryActivity offerSummaryActivity = (OfferSummaryActivity)this.a.get();
            if (offerSummaryActivity != null && !offerSummaryActivity.isFinishing()) {
                offerSummaryActivity.a(bundle, aa.a());
            }
        }
    }
}
