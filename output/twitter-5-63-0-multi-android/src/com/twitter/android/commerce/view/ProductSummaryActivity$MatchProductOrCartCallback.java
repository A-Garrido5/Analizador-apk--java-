...
final class ProductSummaryActivity$MatchProductOrCartCallback extends z
{
    private final WeakReference a;
    private boolean b;
    private ProductSummaryActivity$MatchProductOrCartCallback$RequestType c;
    
    public ProductSummaryActivity$MatchProductOrCartCallback(final ProductSummaryActivity productSummaryActivity, final ProductSummaryActivity$MatchProductOrCartCallback$RequestType c) {
        this.a = new WeakReference((T)productSummaryActivity);
        this.c = c;
    }
    ...
    public void a(final y y) {
        if (!this.b) {
            ...
            Bundle bundle;
            if (aa.a()) {
                bundle = aa.c.getBundle("product_info_bundle");
            }
            else {
                bundle = aa.c.getBundle("commerce_error_list_bundle");
            }
            final ProductSummaryActivity productSummaryActivity = (ProductSummaryActivity)this.a.get();
            if (this.c != ProductSummaryActivity$MatchProductOrCartCallback$RequestType.a) {
                productSummaryActivity.b(bundle, aa.a());
                return;
            }
            productSummaryActivity.a(bundle, aa.a());
        }
    }
}
