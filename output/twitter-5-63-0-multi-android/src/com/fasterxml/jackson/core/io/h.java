...
public final class h extends Writer
{
    ...
    public h(final b a, final OutputStream b) {
        this.f = 0;
        this.a = a;
        this.b = b;
        this.c = a.f();
    ...
    protected static void b(final int n) {
        throw new IOException(c(n));
    }
    ...
    protected int a(final int n) {
        ...
        this.f = 0;
        if (n < 56320 || n > 57343) {
            throw new IOException("Broken surrogate pair: first char 0x" + Integer.toHexString(f) + ", second 0x" + Integer.toHexString(n) + "; illegal combination");
        }
        return 65536 + (f - 55296 << 10) + (n - 56320);
    }
