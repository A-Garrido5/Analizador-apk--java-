...
public abstract class di extends Binder implements dh
{
    public static dh a(final IBinder binder) {
        if (binder == null) {
            return null;
        }
        ...
        if (queryLocalInterface != null && queryLocalInterface instanceof dh) {
            return (dh)queryLocalInterface;
        }
        return new dj(binder);
    }
