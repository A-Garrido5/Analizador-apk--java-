...
public class b
{
    ...
    public static void a(final Parcel parcel, final int n, final List list, final boolean b) {
        if (list == null) {
            if (b) {
                b(parcel, n, 0);
            }
    ...
    public static void a(final Parcel parcel, final int n, final Parcelable[] array, final int n2, final boolean b) {
        if (array == null) {
            if (b) {
                b(parcel, n, 0);
            }
    ...
    private static void a(final Parcel parcel, final Parcelable parcelable, final int n) {
    ...
    public static void b(final Parcel parcel, final int n, final List list, final boolean b) {
        if (list == null) {
            if (b) {
                b(parcel, n, 0);
            }
