...
public class StreetViewPanoramaCamera implements SafeParcelable
{
    ...
    StreetViewPanoramaCamera(final int d, float a, final float n, final float n2) {
    ...
    public String toString() {
        return al.a(this).a("zoom", this.a).a("tilt", this.b).a("bearing", this.c).toString();
    }
