...
public abstract class cd extends Binder implements cc
{
    public static cc a(final IBinder binder) {
        if (binder == null) {
            return null;
        }
        ...
        if (queryLocalInterface != null && queryLocalInterface instanceof cc) {
            return (cc)queryLocalInterface;
        }
        return new ce(binder);
    }
