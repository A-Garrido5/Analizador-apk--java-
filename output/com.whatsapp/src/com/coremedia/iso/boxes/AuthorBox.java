...
public class AuthorBox extends AbstractFullBox
{
    ...
    private static /* synthetic */ void ajc$preClinit() {
        final Factory factory = new Factory("AuthorBox.java", AuthorBox.class);
    ...
    public String getAuthor() {
        RequiresParseDetailAspect.aspectOf().before(Factory.makeJP(AuthorBox.ajc$tjp_1, this, this));
        return this.author;
    }
    ...
    public String getLanguage() {
        RequiresParseDetailAspect.aspectOf().before(Factory.makeJP(AuthorBox.ajc$tjp_0, this, this));
        return this.language;
    }
    
    public void setAuthor(final String author) {
        RequiresParseDetailAspect.aspectOf().before(Factory.makeJP(AuthorBox.ajc$tjp_3, this, this, author));
        this.author = author;
    }
    
    public void setLanguage(final String language) {
        RequiresParseDetailAspect.aspectOf().before(Factory.makeJP(AuthorBox.ajc$tjp_2, this, this, language));
        this.language = language;
    }
    
    @Override
    public String toString() {
        RequiresParseDetailAspect.aspectOf().before(Factory.makeJP(AuthorBox.ajc$tjp_4, this, this));
