...
public class SegmentTypeBox extends AbstractBox
{
    ...
    public SegmentTypeBox(final String majorBrand, final long minorVersion, final List<String> compatibleBrands) {
        super("styp");
        this.compatibleBrands = Collections.emptyList();
    ...
    private static /* synthetic */ void ajc$preClinit() {
        final Factory factory = new Factory("SegmentTypeBox.java", SegmentTypeBox.class);
    ...
    public List<String> getCompatibleBrands() {
        RequiresParseDetailAspect.aspectOf().before(Factory.makeJP(SegmentTypeBox.ajc$tjp_4, this, this));
    ...
    public String getMajorBrand() {
        RequiresParseDetailAspect.aspectOf().before(Factory.makeJP(SegmentTypeBox.ajc$tjp_0, this, this));
        return this.majorBrand;
    }
    
    public long getMinorVersion() {
        RequiresParseDetailAspect.aspectOf().before(Factory.makeJP(SegmentTypeBox.ajc$tjp_3, this, this));
        return this.minorVersion;
    }
    
    public void setCompatibleBrands(final List<String> compatibleBrands) {
        RequiresParseDetailAspect.aspectOf().before(Factory.makeJP(SegmentTypeBox.ajc$tjp_5, this, this, compatibleBrands));
        this.compatibleBrands = compatibleBrands;
    }
    
    public void setMajorBrand(final String majorBrand) {
        RequiresParseDetailAspect.aspectOf().before(Factory.makeJP(SegmentTypeBox.ajc$tjp_1, this, this, majorBrand));
        this.majorBrand = majorBrand;
    }
    
    public void setMinorVersion(final int n) {
        RequiresParseDetailAspect.aspectOf().before(Factory.makeJP(SegmentTypeBox.ajc$tjp_2, this, this, Conversions.intObject(n)));
        this.minorVersion = n;
    }
