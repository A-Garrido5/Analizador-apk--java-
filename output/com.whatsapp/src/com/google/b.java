...
final class b
{
    ...
    byte[] a() {
        final int b = gA.b;
        final byte[] array = new byte[144];
        final int a = this.a.a();
        final int g = this.a.g();
        int n3;
        for (int i = 0; i < a; i = n3) {
            final int[] array2 = com.google.b.b[i];
            int j = 0;
            while (j < g) {
                final int n = array2[j];
                if (n >= 0 && this.a.a(j, i)) {
                    final int n2 = n / 6;
                    array[n2] |= (byte)(1 << 5 - n % 6);
                }
                ++j;
                if (b != 0) {
                    break;
