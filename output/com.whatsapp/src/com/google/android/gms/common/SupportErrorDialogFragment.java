...
public class SupportErrorDialogFragment extends DialogFragment
{
    ...
    public static SupportErrorDialogFragment newInstance(final Dialog dialog, final DialogInterface$OnCancelListener zzVH) {
        final SupportErrorDialogFragment supportErrorDialogFragment = new SupportErrorDialogFragment();
        final Dialog mDialog = (Dialog)zzu.zzb(dialog, "Cannot display null dialog");
