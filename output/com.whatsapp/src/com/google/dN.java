...
public final class dN extends df implements e7
{
    public static du g;
    ...
    private dN(final cL p0, final fu p1) {
        ...
        //    11: aload_0        
        //    12: iconst_m1      
        //    13: putfield        com/google/dN.l:B
        //    16: aload_0        
        //    17: iconst_m1      
        //    18: putfield        com/google/dN.k:I
        //    21: aload_0        
        //    22: invokespecial   com/google/dN.g:()V
        ...
        //    76: aload_2        
        //    77: iload           12
        //    79: invokevirtual   com/google/dN.a:(Lcom/google/cL;Lcom/google/aY;Lcom/google/fu;I)Z
        //    82: istore          14
        //    84: iload           14
        //    86: ifne            139
        //    89: iload           4
        ...
        //   112: putfield        com/google/dN.f:Ljava/util/List;
        //   115: iload           6
        //   117: iconst_1       
        //   118: ior            
        //   119: istore          6
        //   121: aload_0        
        //   122: getfield        com/google/dN.f:Ljava/util/List;
        //   125: aload_1        
        ...
        //   152: aload_0        
        //   153: aload_0        
        //   154: getfield        com/google/dN.f:Ljava/util/List;
        //   157: invokestatic    java/util/Collections.unmodifiableList:(Ljava/util/List;)Ljava/util/List;
        //   160: putfield        com/google/dN.f:Ljava/util/List;
        //   163: aload_0        
        //   164: aload           5
        //   166: invokevirtual   com/google/aY.g:()Lcom/google/ce;
        //   169: putfield        com/google/dN.h:Lcom/google/ce;
        //   172: aload_0        
        //   173: invokevirtual   com/google/dN.c:()V
        //   176: return         
        //   177: iload           4
        //   179: ifeq            267
        //   182: iconst_1       
        ...
        //   211: aload_0        
        //   212: aload_0        
        //   213: getfield        com/google/dN.f:Ljava/util/List;
        //   216: invokestatic    java/util/Collections.unmodifiableList:(Ljava/util/List;)Ljava/util/List;
        //   219: putfield        com/google/dN.f:Ljava/util/List;
        //   222: aload_0        
        //   223: aload           5
        //   225: invokevirtual   com/google/aY.g:()Lcom/google/ce;
        //   228: putfield        com/google/dN.h:Lcom/google/ce;
        //   231: aload_0        
        //   232: invokevirtual   com/google/dN.c:()V
        //   235: aload           9
        //   237: athrow         
        //   238: astore          8
    ...
    protected gB a(final dg dg) {
        return new gB(dg, null);
    }
    ...
    public int getSerializedSize() {
        ...
        return this.k = n + this.c() + this.getUnknownFields().getSerializedSize();
    }
