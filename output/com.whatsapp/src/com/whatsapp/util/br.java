                ...
                try {
                    ...
                    while (true) {
                        while (true) {
                            ...
                            final String s3 = br.b;
                            final StringBuilder sb5 = sb4.append(s3);
                            final String s4 = sb5.toString();
                            Log.i(s4);
                            return;
                            final String s5 = br.b;
                            final boolean b = TextUtils.isEmpty((CharSequence)s5);
