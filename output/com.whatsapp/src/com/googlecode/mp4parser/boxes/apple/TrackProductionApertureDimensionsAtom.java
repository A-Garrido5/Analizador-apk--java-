...
public class TrackProductionApertureDimensionsAtom extends AbstractFullBox
{
    ...
    private static /* synthetic */ void ajc$preClinit() {
        final Factory factory = new Factory("TrackProductionApertureDimensionsAtom.java", TrackProductionApertureDimensionsAtom.class);
    ...
    public double getHeight() {
        RequiresParseDetailAspect.aspectOf().before(Factory.makeJP(TrackProductionApertureDimensionsAtom.ajc$tjp_2, this, this));
        return this.height;
    }
    
    public double getWidth() {
        RequiresParseDetailAspect.aspectOf().before(Factory.makeJP(TrackProductionApertureDimensionsAtom.ajc$tjp_0, this, this));
        return this.width;
    }
    
    public void setHeight(final double height) {
        RequiresParseDetailAspect.aspectOf().before(Factory.makeJP(TrackProductionApertureDimensionsAtom.ajc$tjp_3, this, this, Conversions.doubleObject(height)));
        this.height = height;
    }
    
    public void setWidth(final double width) {
        RequiresParseDetailAspect.aspectOf().before(Factory.makeJP(TrackProductionApertureDimensionsAtom.ajc$tjp_1, this, this, Conversions.doubleObject(width)));
        this.width = width;
    }
}
