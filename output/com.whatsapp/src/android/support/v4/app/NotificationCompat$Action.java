...
public class NotificationCompat$Action extends NotificationCompatBase$Action
{
    ...
    NotificationCompat$Action(final int n, final CharSequence charSequence, final PendingIntent pendingIntent, final Bundle bundle, final RemoteInput[] array, final NotificationCompat$1 notificationCompat$1) {
