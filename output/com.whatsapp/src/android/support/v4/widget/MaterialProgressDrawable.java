...
class MaterialProgressDrawable extends Drawable implements Animatable
{
    ...
    static void access$200(final MaterialProgressDrawable materialProgressDrawable, final float n, final MaterialProgressDrawable$Ring materialProgressDrawable$Ring) {
        materialProgressDrawable.applyFinishTranslation(n, materialProgressDrawable$Ring);
    }
    
    static Interpolator access$300() {
        return MaterialProgressDrawable.START_CURVE_INTERPOLATOR;
    }
    
    static Interpolator access$400() {
        return MaterialProgressDrawable.END_CURVE_INTERPOLATOR;
    }
    
    static float access$500(final MaterialProgressDrawable materialProgressDrawable) {
        return materialProgressDrawable.mRotationCount;
    }
    
    static float access$502(final MaterialProgressDrawable materialProgressDrawable, final float mRotationCount) {
    ...
    private void applyFinishTranslation(final float n, final MaterialProgressDrawable$Ring materialProgressDrawable$Ring) {
        final float n2 = (float)(1.0 + Math.floor(materialProgressDrawable$Ring.getStartingRotation() / 0.8f));
        materialProgressDrawable$Ring.setStartTrim(materialProgressDrawable$Ring.getStartingStartTrim() + n * (materialProgressDrawable$Ring.getStartingEndTrim() - materialProgressDrawable$Ring.getStartingStartTrim()));
        materialProgressDrawable$Ring.setRotation(materialProgressDrawable$Ring.getStartingRotation() + n * (n2 - materialProgressDrawable$Ring.getStartingRotation()));
    }
    ...
    public boolean isRunning() {
        ...
        int n;
        for (int size = mAnimators.size(), i = 0; i < size; i = n) {
