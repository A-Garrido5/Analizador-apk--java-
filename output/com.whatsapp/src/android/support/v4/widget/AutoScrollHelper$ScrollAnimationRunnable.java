...
class AutoScrollHelper$ScrollAnimationRunnable implements Runnable
{
    ...
    AutoScrollHelper$ScrollAnimationRunnable(final AutoScrollHelper autoScrollHelper, final AutoScrollHelper$1 autoScrollHelper$1) {
    ...
    public void run() {
        ...
        final AutoScrollHelper$ClampedScroller access$300 = AutoScrollHelper.access$300(this.this$0);
